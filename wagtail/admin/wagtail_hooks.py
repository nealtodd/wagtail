...
def page_listing_buttons(page, page_perms, is_parent=False):
    ...
    if page.has_unpublished_changes:
        yield PageListingButton(
            ...
            attrs={
                "title": _("Preview draft version of '{title}'").format(
                    title=page.get_admin_display_title()
                ),
                "target": "_blank",
    ...
    if page.live and page.url:
        yield PageListingButton(
            ...
            attrs={
                "target": "_blank",
                "rel": "noopener noreferrer",
                "title": _("View live version of '{title}'").format(
                    title=page.get_admin_display_title()
                ),
            },
            priority=30,
    ...
    if page_perms.can_add_subpage():
        if is_parent:
            yield Button(
                ...
                attrs={
                    "title": _("Add a child page to '{title}' ").format(
                        title=page.get_admin_display_title()
                    )
                },
                classes={
    ...
    yield ButtonWithDropdownFromHook(
        ...
        attrs={
            "target": "_blank",
            "rel": "noopener noreferrer",
            "title": _("View more options for '{title}'").format(
                title=page.get_admin_display_title()
            ),
        },
        priority=50,
...
def page_listing_more_buttons(page, page_perms, is_parent=False):
    if page_perms.can_move():
        yield Button(
            ...
            attrs={
                "title": _("Move page '{title}'").format(
                    title=page.get_admin_display_title()
                )
            },
            priority=10,
    ...
    if page_perms.can_copy():
        yield Button(
            ...
            attrs={
                "title": _("Copy page '{title}'").format(
                    title=page.get_admin_display_title()
                )
            },
            priority=20,
    ...
    if page_perms.can_delete():
        yield Button(
            ...
            attrs={
                "title": _("Delete page '{title}'").format(
                    title=page.get_admin_display_title()
                )
            },
            priority=30,
    ...
    if page_perms.can_unpublish():
        yield Button(
            ...
            attrs={
                "title": _("Unpublish page '{title}'").format(
                    title=page.get_admin_display_title()
                )
            },
            priority=40,
    ...
    if page_perms.can_view_revisions():
        yield Button(
            ...
            attrs={
                "title": _("View revision history for '{title}'").format(
                    title=page.get_admin_display_title()
                )
            },
            priority=50,
...
def register_core_features(features):
    ...
    features.register_editor_plugin(
        ...
        "hr",
        HalloPlugin(
            name="hallohr", js=["wagtailadmin/js/hallo-plugins/hallo-hr.js"], order=45
        ),
    )
